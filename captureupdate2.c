...
static void dump_ppm(const void *p, int size, unsigned int tag, struct timespec *time)
{
   ...
   syslog(LOG_INFO, "capture at %010d usec", (time->tv_sec*1000000 + time->tv_nsec/1000) - (starttime.tv_sec*1000000 + starttime.tv_nsec/1000));
...
unsigned char bigbuffer[(IMG_HEIGHT*IMG_WIDTH)];
...
static int read_frame(void)
{
    ...
    switch (io)
    {
        ...
        case IO_METHOD_MMAP:
            ...
            process_image(buffers[buf.index].start, (HRES*VRES)); //buf.bytesused);
...
int main(int argc, char **argv)
{
    ...
    printf("RGB time = %dusec\n", (RGBtime.tv_sec*1000000 + RGBtime.tv_nsec/1000));
    printf("RGB sharpen time = %dusec\n", (RGBStime.tv_sec*1000000 + RGBStime.tv_nsec/1000));
    printf("Greyscale time = %dusec\n", (Greytime.tv_sec*1000000 + Greytime.tv_nsec/1000));

    printf("\nAverage RGB time = %dusec\n", ((RGBtime.tv_sec*1000000 + RGBtime.tv_nsec/1000) - (starttime.tv_sec*1000000 + starttime.tv_nsec/1000))/30);
    printf("Average RGB sharpen time = %dusec\n", ((RGBStime.tv_sec*1000000 + RGBStime.tv_nsec/1000) - (RGBtime.tv_sec*1000000 + RGBtime.tv_nsec/1000))/30);
    printf("Average Greyscale time = %dusec\n", ((Greytime.tv_sec*1000000 + Greytime.tv_nsec/1000) - (RGBStime.tv_sec*1000000 + RGBStime.tv_nsec/1000))/30);
	 fprintf(stderr, "\n");
    return 0;
}
